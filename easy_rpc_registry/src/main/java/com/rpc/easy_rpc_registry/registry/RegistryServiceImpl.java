...
import com.rpc.easy_rpc_registry.cach.ConsumerConnectCache;
import com.rpc.easy_rpc_registry.cach.ProviderConnectCache;
...
public class RegistryServiceImpl implements RegistryService {
    ...
    @Resource
    RpcConfigProperties.RpcRegistry server;
...
//          发送新的服务列表至所有消费者
            RequestHeader header = new RequestHeader(RequestType.SEND_SERVICE);
